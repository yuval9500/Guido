...
static var defaultPlayer: Player = Player.new("[]", 10, 1,0,[],[],[],0,0,0,0,0,0)
...
static var player1: Player = Player.new("player1", 10, 15, 10, player1Attacks, player1Spells, player1Items,\
2,2,2,2,2,2)
static var player2: Player = Player.new("player2", 10, 10, 8, player2Attacks, player2Spells, player2Items,\
1,1,1,1,1,1)
